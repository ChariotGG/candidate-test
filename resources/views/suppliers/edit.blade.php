    ...
    <div class="py-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 text-sm text-gray-500 dark:text-gray-400">
                ...
                <a href="{{ route('suppliers.show', $supplier) }}" class="hover:text-gray-900 dark:hover:text-gray-100">
                    {{ $supplier->name }}
                </a>
                <span class="mx-2">/</span>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    {{-- FORM UPDATE --}}
                    <form id="form-update-supplier" action="{{ route('suppliers.update', $supplier) }}" method="POST">
                        @csrf
                        @method('PATCH')
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="flex gap-3">
                            ...
                            {{-- SUBMIT UPDATE FORM --}}
                            <button type="submit" form="form-update-supplier"
